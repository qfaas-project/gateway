# QFaaS Note for gateway-openfaas-tcp

Original OpenFaaS `gateway` component (TCP by default)
...
docker images
# You should find a docker image called openfaas/gateway-openfaas-tcp:v3.0
